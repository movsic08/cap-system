<x-app-layout>
    <header class="flex justify-between mb-6 items-center">
        <h2 class="font-semibold text-xl">Rejected Schedules</h2>
    </header>
    <div class="grid grid-cols-12 gap-2">
        <div
            ...
            <a href="{{ route('rejected-baptism.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('rejected-wedding.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('rejected-burial.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('rejected-blessing.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('rejected-confirmation.index') }}" class="px-5 py-5">
