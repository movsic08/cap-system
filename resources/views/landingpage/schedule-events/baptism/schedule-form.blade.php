                                ...
                                <div
                                    ...
                                    <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-2">
                                                <input type="date" name="desired_date" id="desired_date"
                                                    value="{{ old('desired_date') }}" readonly
                                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-2">
                                                <input type="number" name="mothers_contact_number"
                                                    id="mothers_contact_number"
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-2">
                                                <input type="number" name="fathers_contact_number"
                                                    id="fathers_contact_number"
                                        ...
                                        <div class="sm:col-span-3 ">
                                            ...
                                            <div class="mt-2">
                                                <input type="date" name="childs_birthdate" id="childs_birthdate"
                                                    ...
                                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                <x-input-error class="mt-2"
                                                    :messages="$errors->get('childs_birthdate')" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="sm:col-span-3 ">
                                            ...
                                            <div class="mt-2">
                                                <input type="text" name="childs_birthplace" id="childs_birthplace"
                                                    ...
                                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                <x-input-error class="mt-2"
                                                    :messages="$errors->get('childs_birthplace')" />
                                            </div>
                                        </div>
