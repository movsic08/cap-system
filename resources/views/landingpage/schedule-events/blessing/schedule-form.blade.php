    ...
    <form action="{{ route('blessing-schedule-form.store') }}" method="POST">
        ...
        <div class="space-y-12">
            <div class="border-b bg-green-700 p-6 rounded-lg border-gray-900/10 pb-12">
                <h2 class="text-base font-semibold leading-7 text-white">Blessing Schedule Form</h2>
                ...
                <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        <label for="blessing_for" class="block text-sm font-medium leading-6 text-gray-200">
                            Blessing for
                        </label>
                        <div class="mt-2">
                            <input type="text" name="blessing_for" id="blessing_for" value="{{ old('blessing_for') }}"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
