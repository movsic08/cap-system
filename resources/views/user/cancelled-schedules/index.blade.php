<x-app-layout>
    <header class="flex justify-between mb-6 items-center">
        <h2 class="font-semibold text-xl">Cancelled Schedules</h2>
    </header>
    <div class="grid grid-cols-12 gap-2">
        <div
            ...
            <a href="{{ route('user-cancelled-baptism.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('user-cancelled-wedding.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('user-cancelled-burial.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('user-cancelled-blessing.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('user-cancelled-confirmation.index') }}" class="px-5 py-5">
