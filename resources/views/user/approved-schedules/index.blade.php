<x-app-layout>
    ...
    <div class="grid grid-cols-12 gap-2">
        <div
            ...
            <a href="{{ route('user.approved-baptism.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('user.approved-wedding.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('user.approved-burial.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('user.approved-blessing.index') }}" class="px-5 py-5">
        ...
        <div
            class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
            <a href="{{ route('user.approved-confirmation.index') }}" class="px-5 py-5">
