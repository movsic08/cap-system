...
<nav class="space-y-3">
    <div>
        <ul class="mt-3">
            ...
            <x-sidebar-link :href="route('offertory.index')" :active="request()->routeIs('offertory.*')">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor"
                        class="w-5 h-5  transition duration-75 {{ request()->routeIs('offertory.*') ? 'text-[#68BC53]' : 'text-[#b9adad]' }}">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span
                        class="text-sm {{ request()->routeIs('offertory.*') ? 'text-[#68BC53]' : 'text-[#b9adad]' }} font-medium ml-3 lg:opacity-100 2xl:opacity-100 duration-200">
                        {{ __('Offertory') }}
                    </span>
                </div>
            </x-sidebar-link>
